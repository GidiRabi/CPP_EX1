...
TEST_CASE("Test isConnected, shortestPath, isContainsCycle, isBipartite")
{
    ariel::Graph g;
...
//From above are the test cases I added
//From here and down the tests are from the original file
